        ...
        <section className="h-full max-w-5xl mx-auto pt-16 md:pt-8">
          <div className="flex flex-col items-center justify-center md:items-start">
            ...
            <div className="flex items-center mt-8 space-x-6 md:mt-4">
              <motion.a
                href="https://github.com/idrisakan"
                target={"_blank"}
              ...
              <motion.a
                href="https://www.linkedin.com/in/idris-akan-0bb4b32a9/"
                target={"_blank"}
                rel="noopener noreferrer"
                className="flex items-center justify-center text-gray-800 transition-colors duration-300 dark:text-gray-100 dark:hover:text-pinkish-200 hover:text-pinkish-200"
                whileHover={{ scale: 1.1 }}
              ...
              <pre>
                <code className="language-js">
                  ...
                  <div className="flex items-center space-x-4">
                    <img
                      src="https://avatars.githubusercontent.com/u/155467293?s=400&u=5c5c9bb43c7c52007da13e25bf51d0a5c0eda664&v=4"
                      alt="Me"
                  ...
                  <div className="flex items-center space-x-8">
                    <Link className="transition duration-300" href="/projects">
                      Projects
                    </Link>
